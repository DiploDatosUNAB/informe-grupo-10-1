...
Vamos a graficar la tabla anterior sobre las personas secuestradas en grandes centros urbanos. 
...
```{r}
total_poblacion_prov_nac|>
  summarise("Capital Federal","Partidos del Gran Buenos Aires", "Resto de Buenos Aires", "Mendoza", "Córdoba", "Santa Fe")
